...
class BaloncestoHoyWebScraperTest {
    ...
    public static final String LIGA_ENDESA = "Liga Endesa";
    ...
    public void test() {
        ...
        assertEquals(2, result.get(NBA).getEvents().size());

        assertTrue(result.containsKey(LIGA_ENDESA));
        assertEquals(8, result.get(LIGA_ENDESA).getEvents().size());
    }
